				...
				<div class="col-md-12">
					...
					<div class="card card-signup">
						...
						<div class="card-content exam-box">
							<form method="POST" action="DescriptiveExamCategoryController">
							...
							<div id="q${loop.count}" class="question active">
								<!-- =============== Question box start ================= -->
								<input type="hidden" name="ques${loop.count}" value="${categoryBaseQuestionList.quesId}"> 
								...
								<div class="option-box">
									...
									<div class="row">
									    <div class="col-lg-12 col-md-12 col-sm-12">
					                        <div class="form-group has-default bmd-form-group discriptive-awnswer">
					                            <textarea class="form-control" name="desc_ans${loop.count}" placeholder="Type answer here"></textarea>
					                        </div>
					                    </div>
									</div>
									<!--======================== answer End here =========================-->
